...
# Описание основных функций логирования: имя файла, кодировка, уровень.
...
if __name__ == "__main__":
    cl_parser()  # python .\Student.py -name="Запуск Из Консоли"  subjects.csv

    # Проверка основных функиций и тест логирования
