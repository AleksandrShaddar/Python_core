...
# текущие значения text и number в архив (списки archive_text и archive_number) 
...
class Archive:
    ...
    def __str__(self):
        return f'Text is {self.text} and number is {self.number}. Also {super().__init__(archive_text)} and {Archive.archive_number})'
