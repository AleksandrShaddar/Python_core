# Разработать класс Matrix, представляющий матрицу и 
# обеспечивающий базовые операции с матрицами.
...
# rows и cols, а также создает двумерный список data размером rows x cols 
# и заполняет его нулями.
